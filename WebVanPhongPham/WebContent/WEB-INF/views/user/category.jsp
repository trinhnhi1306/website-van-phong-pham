	...
	<div class="row">
		...
		<div class="col-2 py-2 m-2 mbg-azure text-center" >
			<div class="py-2 mb-2" style="height: 125px;">
				<img class="rounded-circle" src="resources/images/categories/mayTinh.png" style="width: 70px; height: 70px;">
		...
		<div class="col-2 py-2 m-2 mbg-azure text-center">
			<div class="py-2 mb-2" style="height: 125px;">
				<img class="rounded-circle" src="resources/images/categories/mayTinh.png" style="width: 70px; height: 70px;">
				<div class="fw-bold py-2 my-auto">Giấy in ảnh - in màu chất lượng cao</div>
			</div>
			<div class="py-2">
				<a class="btn btn-outline-primary" href="#" role="button">Xem</a>
			</div>
