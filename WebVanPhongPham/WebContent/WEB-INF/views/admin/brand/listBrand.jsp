...
<div class="row">
	...
	<div class="col-9 mbg-azure pt-2">
			...
			<div class="col-6">
				<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
					...
					<div class="input-group">
						<input type="text" class="form-control bg-light border small" placeholder="Tên thương hiệu..." aria-label="Search" aria-describedby="basic-addon2">
		...
		<tr class="table-light text-center">
			...
			<td class="text-start">Campus</td>
			<td class="text-start">Chuyên về các dụng cụ học tập...</td>
			<td class=""><a href="admin/editBrand.htm"><i class="fas fa-edit"></i></a></td>
			<td class=""><a href="admin/deleteBrand.htm"><i class="far fa-trash-alt"> </i></a></td>
		</tr>
		<!-- end -->
